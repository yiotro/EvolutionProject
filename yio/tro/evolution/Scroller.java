...
public class Scroller {
    ...
    FactorYio factorModel, selectionFactor;
    ...
    public Scroller(YioGdxGame yioGdxGame, SimpleRectangle frame, float lineHeight, SpriteBatch batch) {
        ...
        bg1 = GameView.loadTextureRegionByName("files/scroller_bg1.png", false);
        bg2 = GameView.loadTextureRegionByName("files/scroller_bg2.png", false);
    ...
    public void move() {
        ...
        animFrame.set(frame.x, frame.y - (1 - factorModel.get()) * 1.2 * frame.height, frame.width, frame.height);
        limit();
        pos += speed;
        speed *= 0.95;
    }
